...
| 电源灯 | 智能 / 全开模式下可单独配色 |
| BIOS 控制 | 直接集成 [UGREEN-NAS-Hardware](https://github.com/BearHero520/UGREEN-NAS-Hardware) 的 `ugreenctl`；DXP4800、DXP4800 Plus / Pro、DXP4800S、DXP480T Plus、DXP6800 Pro 优先经 `it87` hwmon 控制；全部精确映射机型均支持经安全识别的 PCI 有线网卡网络唤醒，以及“安全关机 + RTC 定时开机”计划 |
